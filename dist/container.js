...
const UI_HTTP_1 = __importStar(require("./ui/UI_HTTP"));
const maquina_1 = __importDefault(require("./servicio/maquina"));
const productosMongoDB_1 = __importDefault(require("./DAO/productos/productosMongoDB"));
const server_1 = __importDefault(require("./server"));
const sistemaExt_1 = __importDefault(require("./servicio/sistemaExt"));
exports.container = new inversify_1.Container();
exports.container.bind(container_types_1.default.IUI).to(UI_HTTP_1.default);
exports.container.bind(container_types_1.default.IControlador).to(UI_HTTP_1.Controlador);
exports.container.bind(container_types_1.default.IServicioMaquina).to(maquina_1.default);
exports.container.bind(container_types_1.default.ISistemaExt).to(sistemaExt_1.default);
...
exports.container.bind(container_types_1.default.IDAOProductos).to(productosMongoDB_1.default);
